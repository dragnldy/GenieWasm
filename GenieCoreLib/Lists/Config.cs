...
public class Config
{
    ...
    public string sConnectString = "FE:GENIE /VERSION:" + MyResources.GetApplicationVersion() + " /P:WIN_XP /XML";
    ...
    public string LogDir
    {
        get
        {
            ...
            {
                sLog = Globals.LocalDirectoryPath;
        ...
        try
        {
            ...
            if (sKey.Length > 0)
            {
                ...
                switch (switchExpr)
                {
                    ...
                    case "artdir":
                        {
                            messages.Add(FileDirectory.ValidateDirectory(sValue));
                            ArtDir = sValue;
                            break;
                        }
