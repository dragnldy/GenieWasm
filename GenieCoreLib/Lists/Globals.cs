...
public Events Events = new Events();
    ...
    public class Variables : SortedList
    {
        ...
        public void SetDefaultGlobalVars()
        {
            ...
            Add("client", MyResources.GetApplicationName(), VariableType.Reserved);
            Add("version", MyResources.GetApplicationVersion(), VariableType.Reserved);
    ...
    public class HighlightLineBeginsWith :  SortedList
    {
    ...
    public class HighlightRegExp : SortedList
    {
        public class Highlight
        {
            public string Text = string.Empty;
